      ...
      >
        ...
        <div className="absolute top-2.5 right-2.5 flex flex-col items-end gap-1 z-10">
          ...
          {product.isBestSeller && (
            <span className="px-2 py-0.5 rounded-md text-[10px] font-bold bg-amber-400 text-slate-950 shadow-xs flex items-center space-x-0.5">
      ...
      <div className="p-4 flex-1 flex flex-col justify-between space-y-3">
        ...
        <div className="pt-2 border-t border-slate-100 space-y-2">
          ...
          <button
            ...
            className="w-full py-2 bg-amber-50 hover:bg-amber-100 text-amber-900 border border-amber-300 font-bold text-xs rounded-xl transition-colors flex items-center justify-center space-x-1.5 shadow-xs cursor-pointer"
          >
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <button
              ...
              className="py-2 bg-slate-900 hover:bg-indigo-600 text-white font-bold text-xs rounded-xl transition-colors text-center shadow-xs cursor-pointer"
            >
              {isOutOfStock ? 'Notify / Pre-Order' : 'Order / Hold'}
            </button>
          </div>
