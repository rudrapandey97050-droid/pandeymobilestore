...
export const RepairSection: React.FC<RepairSectionProps> = ({
  ...
  return (
    <section id="repair-section" className="py-12 bg-slate-900 text-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-gradient-to-r from-indigo-950 via-slate-800 to-slate-900 rounded-3xl p-6 sm:p-8 border border-slate-700 flex flex-col lg:flex-row items-center justify-between gap-8 shadow-xl">
          <div className="space-y-3 text-center lg:text-left max-w-2xl">
            <div className="inline-flex items-center space-x-1.5 text-xs font-bold text-amber-400 uppercase tracking-wider bg-amber-500/20 px-3 py-1 rounded-full border border-amber-500/30">
